<template>
  <section class="hero is-small is-info">
    <div class="hero-body has-text-centered">
      <p class="title">Your Order Number: #{{ order_number }}</p>
      <p class="subtitle">Order Placed on: {{ dateParse(date_created) }}</p>
    </div>
  </section>
              ...
              <div class="box has-background-transparent">
                              ...
                              <div class="media-content">
                                ...
                                >
                                  <p class="title is-5 has-text-link">
                                    {{ item.name }}
                                    <span
                                      class="tag is-small is-info is-light is-rounded"
                                    >
                                      x{{ item.quantity }}
                                    </span>
                                  </p>
                ...
                >
                  <button
                    class="button"
                    v-if="previous_page"
                    @click="update_items(previous_page)"
                  >
                    Previous
                  </button>
                  <button
      ...
      <div class="tile is-3 is-parent is-vertical">
        <div class="tile is-child box">
          ...
          <div class="box has-background-white">
            <div
              v-for="(shipping_info, key, index) in shipping_address"
              :key="index"
            >
