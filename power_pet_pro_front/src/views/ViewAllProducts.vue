<template>
  ...
  <nav class="pagination is-centered" role="navigation" aria-label="pagination">
    <button
      ...
      v-if="previous"
      @click="changeView(previous)"
    >
      Previous
    </button>
    <button class="pagination-next" v-if="next" @click="changeView(next)">
      Next page
    </button>
  ...
  <div class="modal" :class="{ 'is-active': edit_mode }">
    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        ...
        <div class="field">
          ...
          <textarea
            ...
            v-model="chosen_product_description"
          ></textarea>
        </div>
        <div class="field">
      ...
      <footer class="modal-card-foot">
        <button class="button is-success" @click="edit_product()">
          Save changes
        </button>
  ...
  <div class="modal" :class="{ 'is-active': delete_mode }">
    ...
    <div class="modal-card">
      ...
      <footer class="modal-card-foot">
        ...
        <button class="button" @click="toggle_mode('d')">Cancel</button>
      </footer>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    edit_product() {
      ...
      let category_id = this.categories.find(
        (category) => category.name === this.chosen_product_category
      ).id;
