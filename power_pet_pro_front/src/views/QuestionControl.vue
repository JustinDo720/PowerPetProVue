          ...
          <ul>
            <li v-for="(question, index) in current_questions" :key="index">
              <h3 class="title is-3 has-text-white">
                ...
                <span>
                  <button
                    class="button is-outlined is-danger is-small ml-2"
              ...
              <div class="columns">
                <div class="column" id="added_question">
                  <div class="content">
                    ...
                    <ul>
                      <li
                        v-for="(added_question, index) in added_questions"
                        :key="index"
                      >
                        <span>
                ...
                <div class="column" id="add_question">
                  ...
                  <div class="control">
                    <input
                      class="input"
                      type="text"
                      v-model="added_question"
                      @keydown.enter="add_question()"
                    />
                  </div>
                  <br />
                  <div>
    ...
    <div class="modal" :class="{ 'is-active': confirm_remove_question }">
      ...
      <div class="modal-content">
        ...
        <div class="box has-text-centered">
          <div class="content">
            <h2 class="title is-2">
              Removing: {{ removed_question.questions }}
            </h2>
          </div>
          <div>
            <button
              class="button is-outlined is-danger"
              @click="remove_confirmed_question(removed_question)"
            >
...
export default {
  ...
  methods: {
    ...
    remove_confirmed_question(question_obj) {
      ...
      axios
        .delete(
          `admin_panel/feedbacks/remove_questions/${question_obj.id}/`,
          config
        )
        .then((response) => {
          this.confirm_remove_question = !this.confirm_remove_question;
