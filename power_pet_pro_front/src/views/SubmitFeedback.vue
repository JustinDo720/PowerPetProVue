  ...
  <section class="hero is-fullheight is-info">
    <div class="hero-body">
      <div class="container has-text-centered">
        ...
        <hr />
        <p class="subtitle">
          Please fill out this form and and the upcoming survey to let me know
          about your opinions
        </p>
        ...
        <div class="columns is-centered">
          <div class="column is-5">
            <form
              class="box"
              @submit.prevent="submit_feedback()"
              v-if="feedback_mode"
            >
                ...
                <div class="control">
                  <div class="box">
                    ...
                    <div>
                      <label
                        class="radio"
                        v-for="(ans_choice, index) in question.ans_choices"
                        :key="index"
                      >
                        <input
                          v-model="answer_form.answers[question.id]"
                          type="radio"
                          :name="question.id"
                          v-bind:value="ans_choice[0]"
                        />
                        {{ ans_choice[1] }}
                      </label>
                    </div>
...
export default {
  ...
  methods: {
    user_feedback() {
      axios
        .get(`feedbacks/get_feedback/${this.feedback_id}/`)
        .then((response) => {
